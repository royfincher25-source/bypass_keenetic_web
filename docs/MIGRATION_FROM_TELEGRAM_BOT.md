...
scp -r "H:\disk_e\dell\bypass_keenetic-web\src\web_ui" root@192.168.1.1:/opt/etc/web_ui/
```
...
- GitHub Issues: https://github.com/royfincher25-source/bypass_keenetic-web/issues
- Discussions: https://github.com/royfincher25-source/bypass_keenetic-web/discussions
